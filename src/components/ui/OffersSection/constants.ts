...
export const desktopHeaderPhrases = [
  ...
  'Journey with Paycrypt',
];
export const desktopParagraphPhrase = [
  'Paycrypt offers a world of financial possibilities. From investments to payments,',
  "we've got you covered. Join us and unlock your potential today.",
];

// For mobile
export const mobileParagraphPhrase = [
  'Paycrypt offers a world of financial possibilities. From',
